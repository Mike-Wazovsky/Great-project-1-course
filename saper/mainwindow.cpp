...
Button *MainWindow::createButton(int k, int i, int j)
{
...
void MainWindow::waiting_end() {
    ui->label->setText("Пожуй говна"); //TODO delete this
}

void MainWindow::check_zero(int i, int j) {
